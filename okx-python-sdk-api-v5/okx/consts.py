...
MOVE_ASSETS = '/api/v5/account/move-positions'
...
BILLS_INFO_HISTORY = '/api/v5/asset/bills-history'
...
BUY_SELL_CURRENCIES = '/api/v5/fiat/buy-sell/currencies'
BUY_SELL_CURRENCIES_PAIR = '/api/v5/fiat/buy-sell/currency-pair'
BUY_SELL_QUOTE = '/api/v5/fiat/buy-sell/quote'
BUY_SELL_TRADE = '/api/v5/fiat/buy-sell/trade'
BUY_SELL_HISTORY = '/api/v5/fiat/buy-sell/history' 
# Market Data
...
GET_MARKET_DATA_HISTORY = '/api/v5/public/market-data-history'
...
POSITION_BUILDER_GRAPH = '/api/v5/account/position-builder-graph'
...
STAKING_DEFI_SOL_PRODUCT_INFO = 'STAKING_DEFI_SOL_PRODUCT_INFO'
