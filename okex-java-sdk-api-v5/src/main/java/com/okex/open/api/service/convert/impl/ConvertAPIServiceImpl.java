...
public class ConvertAPIServiceImpl implements ConvertAPIService {
    ...
    @Override
    public JSONObject getHistory(String clTReqId,String after ,String before,String limit,String tag) {
        return this.client.executeSync(this.api.getHistory(clTReqId,after,before,limit,tag));
    }
}
