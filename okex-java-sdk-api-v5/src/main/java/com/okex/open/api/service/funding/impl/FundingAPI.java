...
interface FundingAPI {
    ...
    Call<JSONObject> getDepositHistory(@Query("ccy") String ccy,@Query("txId") String txId,@Query("fromWdId") String fromWdId,@Query("type") String type,@Query("state")String state,@Query("after")String after,@Query("before")String before,@Query("limit")String limit,@Query("depId")String depId);
    ...
    Call<JSONObject> getDepositWithdrawalStatus(@Query("wdId") String wdId,@Query("txId") String txId,@Query("ccy") String ccy,@Query("to") String to,@Query("chain")String chain);
