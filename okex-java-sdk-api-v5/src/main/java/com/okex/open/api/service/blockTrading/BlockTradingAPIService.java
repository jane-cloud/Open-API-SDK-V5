...
public interface BlockTradingAPIService {
    ...
    //获取大宗交易信息 Get trades
    JSONObject getTrades(String rfqId, String clRfqId, String quoteId,String clQuoteId,String state, String beginId, String endId, String limit, String beginTs, String endTs,String isSuccessful);
